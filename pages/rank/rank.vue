	...
	<view>
				...
				<view class="top">
					...
					<view class="two">
						<view style="padding: 0;margin-left: 95rpx;margin-bottom: -10rpx;">
							<u-icon name="/static/rank/two.png" size="50rpx"></u-icon>
						</view>
						<view
					...
					<view class="one">
						<view style="padding: 0;margin-left: 95rpx;margin-bottom: -10rpx;">
							<u-icon name="/static/rank/one.png" size="50rpx"></u-icon>
						</view>
						<view
							style="border: 4rpx solid #dedfdf; width: 100rpx; height: 100rpx;border-radius: 100%;margin-left: 65rpx;">
					...
					<view class="three">
						<view style="padding: 0;margin-left: 95rpx;margin-bottom: -10rpx;">
							<u-icon name="/static/rank/three.png" size="50rpx"></u-icon>
						</view>
						<view
							style="border: 4rpx solid #dedfdf; width: 100rpx; height: 100rpx;border-radius: 100%;margin-left: 65rpx;">
		...
		<view class="foot">
			<view style="margin: 30rpx 80rpx;">
				<u-row>
					<u-col span="3">
						<u-avatar src="/static/rank/head.png" size="80rpx"></u-avatar>
					</u-col>
					<u-col span="9">
